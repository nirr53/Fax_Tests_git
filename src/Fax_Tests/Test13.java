...
/**
* ----------------
* This test tests a send of failure on fax convert
* -----------------
* Tests:
*    1. Send a fax that the system cannot convert.
* 
* Results:
...
public class Test13 {
  ...
  @Test
  public void Test13___Fax_failure() throws Exception {
	  ...
	  dataMap.put("outputPath",  testVars.getOutputDirPath() + "Test13.txt");
