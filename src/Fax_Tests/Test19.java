...
/**
* ----------------
* This test tests a send of a fax with pdf attachment
* -----------------
* Tests:
*    1. Send a fax with one pdf attachment
*    2. Send a fax with multiple pdf attachments
* 
* Results:
* 	In all cases:
...
public class Test19 {
  ...
  public void test1() throws Exception {
	  ...
	  // Step 1 - Deposit fax with one pdf attachment
	  testFuncs.myDebugPrinting("Step 1 -  Deposit fax with one pdf attachment");
	  dataMap.put("outputPath",  testVars.getOutputDirPath() + "Test19_1.eml");
  ...
  public void test2() throws Exception {
	  ...
	  dataMap.put("outputPath",  testVars.getOutputDirPath() + "Test19_2.eml");
	  testFuncs.depositFax(testVars.getFaxHeaders(), dataMap);
	  testFuncs.activateFaxOCR(testVars.getOCRPath(), testVars.getRootDir(), "att_Fax_Message_Body");
