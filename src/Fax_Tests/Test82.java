...
/**
* ----------------
* This test tests the Fax-ID Select Method (System-Fax-ID) with numbers
* -----------------
* Tests:
* 	 - Set the Fax-ID Select method to be 'System-Fax-ID'
* 	 - Set the Fax-ID to be '1234567890'
*    - Set the default CLI to be '1234'
*    1. Send a fax.
* 
* Results:
*    1. All the three parts of fax - status, body and result should be accepted on given timeout.
* 	    The Fax-ID header should be '1234567890'.
...
public class Test82 {
  ...
  public void Test82___Fax_ID_with_numbers() throws Exception {
	  ...
	  dataMap.put("outputPath",  testVars.getOutputDirPath() + "Test82.eml");
