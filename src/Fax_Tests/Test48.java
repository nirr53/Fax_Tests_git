...
/**
* ----------------
* This test tests a send of an email to fax when cover-page checkbox is checked
* -----------------
* Tests:
...
public class Test48 {
  ...
  public void test2() throws Exception {
	  ...
	  dataMap.put("outputPath",  testVars.getOutputDirPath() + "Test48_2.txt");
