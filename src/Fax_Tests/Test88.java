...
/**
* ----------------
* This test tests a deposit of fax with pdf attachment that has multiple languages
* -----------------
* Tests:
*    1. Deposit a fax with pdf attachment that has multiple languages
*    2. Deposit a fax with body that has some languages (Unicode)
* 
* Results:
* 	In all cases:
...
public class Test88 {
  ...
  public void test1() throws Exception {
	  ...
	  // Step 1 - Deposit a fax with pdf attachment that has multiple languages
  ...
  public void test2() throws Exception {
	  ...
	  dataMap.put("outputPath",  testVars.getOutputDirPath() + "Test88_2.eml");
	  testFuncs.depositFax(testVars.getFaxHeaders(), dataMap);
  }
