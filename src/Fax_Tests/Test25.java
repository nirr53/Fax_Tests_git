...
/**
* ----------------
* This test tests a send of a fax with ppt attchment
* -----------------
* Tests:
...
public class Test25 {
  ...
  @Test
  public void Test25___Fax_ppt_attachment() throws Exception {
	  ...
	  testFuncs.myAssertTrue("Title was not detected !!", bodyMsg.contains("Fax Contains: 3 page(s)"));
